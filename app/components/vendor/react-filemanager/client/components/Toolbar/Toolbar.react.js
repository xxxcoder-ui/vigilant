...
const propTypes = {
  ...
  newButtonItems: PropTypes.arrayOf(
    PropTypes.shape({
      label: PropTypes.string,
      icon: PropTypes.object,
      onClick: PropTypes.func
...
export default class Toolbar extends Component {
  ...
  render() {
    ...
    const newButtonElement = newButtonText ? (
      <button onClick={this.handleShowDropdownMenu} className="oc-fm--toolbar__new-button">
        {newButtonText}
      </button>
    ) : (
    ...
    const dropdownMenuElement = showDropdownMenu ? (
      <DropdownMenu show={showDropdownMenu} onHide={this.handleHideDropdownMenu}>
        {dropdownMenuItems}
      </DropdownMenu>
    ) : null
    ...
    const newButtonContainer = newButtonText ? (
      ...
      <div className="oc-fm--toolbar__items">{newButtonElement}</div>
    )
