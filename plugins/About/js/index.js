...
function genDownloadLink (version, thePlatform) {
  ...
  return `https://github.com/SiaPrime/SiaPrime-UI/releases/download/v${version}/SiaPrime-UI-v${version}-${plat}-x64.zip`
}
...
document.getElementById('datadiropen').onclick = () => {
  shell.showItemInFolder(SiaAPI.config.spd.datadir)
}
